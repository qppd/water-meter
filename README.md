...
| 6 | **Enclosure** — Mount in IP67 box with cable glands | [block-diagram.md](./docs/block-diagram.md) | 1 hr |
...
| 9 | **Install library** — `Firebase ESP Client` by Mobizt (ArduinoJson bundled) | [esp32-firmware-complete-guide.md](./docs/esp32-firmware-complete-guide.md) | 5 min |
| 10 | **Configure `config.h`** — WiFi, Firebase API key, DB URL, user email/password, device ID | [esp32-firmware-complete-guide.md](./docs/esp32-firmware-complete-guide.md) | 10 min |
...
| 12 | **Verify** — Serial Monitor (115200): WiFi connect → Firebase stream start → sensor ISRs attached | [esp32-firmware-complete-guide.md](./docs/esp32-firmware-complete-guide.md) | 5 min |
...
| Step | Action | Guide | Est. Time |
|------|--------|-------|-----------|
| 13 | **Bucket test each sensor** — 5L measured, calculate PPL, update `config.h` | [esp32-firmware-complete-guide.md](./docs/esp32-firmware-complete-guide.md) | 30 min/sensor |
...
| 16 | **Copy `firebase_config.json` + `.env`** (from Firebase web app config) | [pi-complete-setup.md](./docs/pi-complete-setup.md) | 5 min |
...
|-----------|-----|----------|
| ESP32 38-pin (ESP32 Dev Module) | 1 | CP2102/CH340 USB-UART |
